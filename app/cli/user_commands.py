...
@click.option('--role', default='therapist', type=click.Choice(['admin', 'therapist', 'viewer']), help='User role')
@with_appcontext
...
@click.option('--email', prompt=True, help='User email address')
@click.option('--role', prompt=True, type=click.Choice(['admin', 'therapist', 'viewer']), help='New role')
@with_appcontext
