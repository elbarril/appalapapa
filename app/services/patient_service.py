...
class PatientService:
    ...
    @staticmethod
    def create(name: str, user_id: Optional[int] = None, notes: Optional[str] = None) -> Tuple[bool, Optional[Person], str]:
        """
    ...
    @staticmethod
    def update(person_id: int, name: str, user_id: Optional[int] = None, notes: Optional[str] = None) -> Tuple[bool, Optional[Person], str]:
        """
        ...
        existing = Person.query_active().filter(
            Person.name == name,
            Person.id != person_id
        ).first()
        if existing:
